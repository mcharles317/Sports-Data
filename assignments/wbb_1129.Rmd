...
ggplot() + 
  geom_bar(
    data=State, 
    aes(x=pm.state, weight =count)
  ) + 
  labs(
    title="Women's College Basketball by State", 
    x="State", 
    y="Number of Players") 
```
```{r}
ggplot() + 
  geom_bar(
    data=Year, 
    aes(x=year_clean, weight =count)
  ) + 
  labs(
    title="Women's College Basketball Players by Academic Year", 
    x="Year", 
    y="Number of Players") + 
  theme_minimal()
```
...
ggplot() + 
  geom_bar(
    data=Positions, 
    aes(x=position_full, weight =count)
  ) + 
  labs(
    title="Women's College Basketball by Position", 
    x="Position", 
    y="Number of Players") + 
  theme_minimal()
```
